...
Scheme
{
	...
	BaseSettings
	{
		...
		Button.ArmedTextColor			"EyeText1"
		...
		CheckButton.SelectedTextColor	"EyeText1"
		...
		PropertySheet.SelectedTextColor	"EyeText1"
		PropertySheet.TransitionEffectTime	"0.25"	// time to change from one tab to another

		RadioButton.TextColor			"EyeText1"
		RadioButton.SelectedTextColor	"EyeText1"

		RichText.TextColor				"EyeText1"
		RichText.BgColor				"EYEBGBright"
		RichText.SelectedTextColor		"EyeText1"
		RichText.SelectedBgColor		"EyeText1"
		...
		SectionedListPanel.SelectedTextColor			"EyeText1"
		SectionedListPanel.SelectedBgColor				"Orange"
		SectionedListPanel.OutOfFocusSelectedTextColor	"EyeText1"
		SectionedListPanel.OutOfFocusSelectedBgColor	"255 155 0 128"

		Slider.NobColor				"108 108 108 255"
		Slider.TextColor			"180 180 180 255"
		Slider.TrackColor			"31 31 31 255"
		Slider.DisabledTextColor1	"EyeText1"
		Slider.DisabledTextColor2	"EyeText1"

		TextEntry.TextColor			"EyeText1"
		TextEntry.BgColor			"TransparentBlack"
		TextEntry.CursorColor		"OffWhite"
		TextEntry.DisabledTextColor	"EyeText1"
		TextEntry.DisabledBgColor	"Blank"
		TextEntry.SelectedTextColor	"EyeText1"
		...
		MainMenu.ArmedTextColor		"EyeText1"
		MainMenu.DepressedTextColor	"EyeText1"
